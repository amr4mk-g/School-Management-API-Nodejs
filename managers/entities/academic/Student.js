...
const studentSchema = new Schema(
  {
    ...
    //Classes are from level 1 to 6, track of the class level the student is in
    classLevels: [{type: String}],
    currentClassLevel: {type: String,
      default: function () {return this.classLevels[this.classLevels.length - 1];},
    },
